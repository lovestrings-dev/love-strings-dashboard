-- Invitation acceptance creates a membership, preference row, and acceptance
-- audit together. The function is service-role-only; the route independently
-- verifies the Supabase user session before it invokes this function.
