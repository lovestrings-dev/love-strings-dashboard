...
type PlatformWorkspace = { access_state: "active" | "frozen"; created_at: string; id: string; name: string; pendingAdminEmail: string | null; setup_state: "active" | "pending_setup"; slug: string };
