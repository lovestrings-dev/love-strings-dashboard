export const dashboardCardRegistry = [
  ...
  { id: "platforms.instagram", label: "Instagram (Business)", parentId: "platforms", visibleByDefault: true },
  { id: "platforms.instagram-creator", label: "Instagram (Creator)", parentId: "platforms", visibleByDefault: true },
  { id: "platforms.threads", label: "Threads", parentId: "platforms", visibleByDefault: true },
